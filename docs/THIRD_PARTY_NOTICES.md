...
Documentation illustrations are generated from fictional data by `scripts/render_previews.py`; they contain no desktop screenshots or embedded personal profiles.
