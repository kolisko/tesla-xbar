...
| [`images/`](images/README.md) | Menu bar, dropdown and state illustrations, with SVG sources and PNG previews. |

The [main README](../README.md) contains the feature overview, user configuration and repository map. Architecture is maintained in [ARCHITECTURE.md](ARCHITECTURE.md). Contribution and security policies are in [`.github/`](../.github/OVERVIEW.md).
