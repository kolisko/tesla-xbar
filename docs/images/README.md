...
| [`status-icons.svg`](status-icons.svg), [`status-icons.png`](status-icons.png) | Matching charging, Camp Mode, Pet Mode, climate fan, open padlock, Sentry and open front/rear trunk icons, plus combined and repeated-read-error menu-bar examples. |
